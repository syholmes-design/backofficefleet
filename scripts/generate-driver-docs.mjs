...
function main() {
  ...
  for (const driver of drivers) {
    ...
    const payload = {
      ...
      primaryEmergencyName: driver.primaryEmergencyName || driver.emergencyContactName,
      primaryEmergencyRelationship: driver.primaryEmergencyRelationship || driver.emergencyContactRelationship,
      primaryEmergencyPhone: driver.primaryEmergencyPhone || driver.emergencyContactPhone,
      primaryEmergencyEmail: driver.primaryEmergencyEmail || driver.emergencyContactEmail,
      primaryEmergencyAddress: driver.primaryEmergencyAddress || driver.emergencyContactAddress || driver.address,
      secondaryEmergencyName: driver.secondaryEmergencyName || driver.secondaryContactName,
      secondaryEmergencyRelationship: driver.secondaryEmergencyRelationship || driver.secondaryContactRelationship,
      secondaryEmergencyPhone: driver.secondaryEmergencyPhone || driver.secondaryContactPhone,
      secondaryEmergencyEmail: driver.secondaryEmergencyEmail || driver.secondaryContactEmail,
