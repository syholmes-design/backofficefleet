...
export const OPERATIONS_FILE_CABINET_REGISTRY: OperationsFileCabinetItem[] = [
  ...
  },
  {
    ...
    audience: ["driver", "manager", "hr"],
    status: "available",
    description: "Standard driver employment application form for an active BOF driver file.",
    href: "/generated/drivers/DRV-001/driver-application.html",
    sourceAuthenticity: "generated_from_template",
    documentOwner: "employer",
    employerName: "Delta Advanced Trucking, Inc.",
    isCompletedSample: true,
    tags: ["application", "employment", "driver file"]
  },
  {
  ...
  },
  {
    ...
    audience: ["driver", "manager", "hr"],
    status: "available",
    description: "Complete driver profile and documentation access for a live BOF driver record.",
    href: "/generated/drivers/DRV-001/john-carter-profile-dashboard.html",
    sourceAuthenticity: "generated_from_template",
    documentOwner: "employer",
    employerName: "Delta Advanced Trucking, Inc.",
    isCompletedSample: true,
    tags: ["profile", "dashboard", "driver file"]
  },
  {
  ...
  // Secondary Driver Documents
  {
    ...
    status: "available",
    description: "Driver coaching documentation and follow-up records created from the active BOF HR review workflow.",
    href: "/generated/company-operations-vault/hr-templates/driver-coaching-corrective-action-form.html",
    sourceAuthenticity: "generated_from_template",
    documentOwner: "employer",
    employerName: "Delta Advanced Trucking, Inc.",
    isCompletedSample: true,
    tags: ["coaching", "documentation", "review"]
  },
  {
    ...
    audience: ["driver", "manager", "safety"],
    status: "available",
    description: "Representative safety performance and review record from the current BOF annual review workflow.",
    href: "/generated/company-operations-vault/hr-samples/noah-wilson-annual-performance-review-2026.html",
    sourceAuthenticity: "generated_from_template",
    documentOwner: "employer",
    employerName: "Delta Advanced Trucking, Inc.",
    isCompletedSample: true,
    tags: ["safety", "performance", "review"]
  },
  {
  ...
  },
  {
    ...
    audience: ["driver", "manager", "hr", "safety"],
    status: "available",
    description: "Training and onboarding completion records as represented in the BOF company operations library.",
    href: "/generated/company-operations-vault/03-hr-onboarding-and-offboarding-checklist.html",
    sourceAuthenticity: "generated_from_template",
    documentOwner: "employer",
    employerName: "Delta Advanced Trucking, Inc.",
    isCompletedSample: true,
    tags: ["training", "completion", "onboarding"]
  },
  {
    ...
    audience: ["driver", "manager", "hr"],
    status: "available",
    description: "Corrective action and review record from the active BOF driver management workflow.",
    href: "/generated/company-operations-vault/hr-templates/driver-coaching-corrective-action-form.html",
    sourceAuthenticity: "generated_from_template",
    documentOwner: "employer",
    employerName: "Delta Advanced Trucking, Inc.",
    isCompletedSample: true,
    tags: ["disciplinary", "corrective action", "review"]
  },
  {
  ...
  },
  {
    ...
    status: "available",
    description: "Vehicle inspection and safety check before departure using the current BOF trip-release flow.",
    href: "/trip-release/L001",
    sourceAuthenticity: "generated_from_template",
    documentOwner: "employer",
    employerName: "Delta Advanced Trucking, Inc.",
    isCompletedSample: true,
    tags: ["vehicle", "inspection", "trip release"]
  },
  {
  ...
  // Finance / Settlements / Back Office Cabinet - Add missing cabinet
  {
    ...
    status: "available",
    description: "Standard invoice template for billing and settlements using the BOF generated load packet.",
    href: "/generated/loads/L001/invoice.html",
    sourceAuthenticity: "generated_from_template",
    documentOwner: "employer",
    employerName: "Delta Advanced Trucking, Inc.",
  ...
  },
  {
    ...
    audience: ["driver", "manager", "finance"],
    status: "available",
    description: "Employee expense reporting and reimbursement form mapped to the current settlement support workflow.",
    href: "/generated/settlements/L003/lumper-reimbursement-support.html",
    sourceAuthenticity: "generated_from_template",
    documentOwner: "employer",
    employerName: "Delta Advanced Trucking, Inc.",
    isCompletedSample: true,
    tags: ["expense", "reimbursement", "settlement"]
  },
  ...
  // Training & Knowledge Base Cabinet - Add missing cabinet
  {
    ...
    audience: ["driver", "manager", "safety"],
    status: "available",
    description: "Comprehensive safety training program and materials grounded in the active BOF safety policy library.",
  ...
  },
  {
    ...
    description: "External compliance training resources and courses from official DOT and FMCSA sources.",
  ...
  // Add missing Claims Forms section
  {
    ...
    audience: ["driver", "manager", "safety", "legal"],
    status: "available",
    description: "Comprehensive accident reporting and documentation form with active BOF claims evidence support.",
    href: "/generated/claims/L003/accident-report.html",
    sourceAuthenticity: "generated_from_template",
    documentOwner: "employer",
    employerName: "Delta Advanced Trucking, Inc.",
  ...
  },
  {
    ...
    status: "available",
    description: "Cargo damage assessment and reporting form from the active claim packet workflow.",
    href: "/generated/claims/L003/damage-photo-packet.html",
    sourceAuthenticity: "generated_from_template",
    documentOwner: "employer",
    employerName: "Delta Advanced Trucking, Inc.",
