...
export const BOF_PAGE_REGISTRY: Record<string, BofPageRegistryItem> = {
  ...
  commandCenter: {
    ...
    primaryComponent: "ProductionCommandCenter",
  },
  demoCommandCenter: {
    label: "DEMO Command Center",
    url: "/demo/command-center",
    type: "DEMO",
    routeFile: "app/(bof)/demo/command-center/page.tsx",
    primaryComponent: "CommandCenterV4",
  },
  demoDispatch: {
    label: "DEMO Dispatch",
    url: "/demo/dispatch",
    type: "DEMO",
    routeFile: "app/(bof)/demo/dispatch/page.tsx",
    primaryComponent: "DispatchShell",
  },
  demoLoads: {
    label: "DEMO Loads",
    url: "/demo/loads",
    type: "DEMO",
    routeFile: "app/(bof)/demo/loads/page.tsx",
    primaryComponent: "LoadsPageClient",
  },
  demoDrivers: {
    label: "DEMO Drivers",
    url: "/demo/drivers",
