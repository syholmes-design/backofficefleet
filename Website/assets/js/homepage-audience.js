(function () {
  ...
  var states = {
    ...
    vault: {
      ...
      caption: "BOF Vault is the driver-facing intake layer for CDL, medical card, MVR, DQF, insurance, proof packets, and exception follow-up.",
      cards: [
        ["CDL", "Ready", "Verified"],
      ...
      scenarioLabel: "Open BOF Vault demo"
    }
  };
