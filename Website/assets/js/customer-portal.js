(function () {
  ...
  var portal = {
    ...
    quoteMessage: "Temporary quote prepared. Approve it to submit a pending load request for BOF dispatch review."
  };
  ...
  function renderAll() {
    ...
    if (dispatchState.quoteApproved) {
      ...
      portal.quoteMessage = "Quote approved and pending load request created. BOF dispatch still clears assignment, compliance, equipment, and pre-trip packet gates.";
    }
    renderQuoteLines();
    renderIds();
    renderPaper();
