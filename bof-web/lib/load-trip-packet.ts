...
export function buildTripDocumentPacket(data: BofData, loadId: string): TripPacket | null {
  ...
  const rowsUncached: TripPacketRow[] = [
    ...
    },
    {
      ...
      url: workOrderUrl,
      note: workOrderUrl ? undefined : "Work order is awaiting dispatch filing.",
      requiredForSettlementRelease: true,
      deliveredMinimum: true,
    ...
    },
    {
      ...
      url: bolUrl,
      note: bolUrl ? undefined : "BOL is awaiting shipper or dispatch filing.",
      requiredForSettlementRelease: true,
      deliveredMinimum: true,
    ...
    },
    {
      ...
      url: rfidUrl,
      note: rfidUrl ? undefined : "RFID/geo summary is awaiting checkpoint confirmation.",
      requiredForSettlementRelease: false,
      deliveredMinimum: false,
    ...
    },
    {
      ...
      note: factoringUrl ? undefined : "Factoring notice is not required for this load.",
      requiredForSettlementRelease: false,
      deliveredMinimum: false,
