...
export const OPERATIONS_FILE_CABINET_REGISTRY: OperationsFileCabinetItem[] = [
  ...
  // Driver Qualification Files - Executed Operational Records
  {
    id: "driver-cdl-sample-john-carter",
    title: "Executed CDL Record — John Carter",
    cabinet: "Driver Qualification Files",
    section: "Executed Operational Records",
    category: "Driver Qualification Files",
    type: "driver-file",
    audience: ["driver", "manager", "hr", "safety"],
    status: "available",
    description: "Executed CDL verification and qualification record",
  ...
  },
  {
    ...
    title: "Executed Medical Card — John Carter",
    cabinet: "Driver Qualification Files",
    section: "Executed Operational Records",
    category: "Driver Qualification Files",
    type: "driver-file",
    audience: ["driver", "manager", "hr", "safety"],
    status: "available",
    description: "Executed medical card and DOT physical record",
  ...
  },
  {
    ...
    title: "MVR Executed Record — John Carter",
    cabinet: "Driver Qualification Files",
    section: "Executed Operational Records",
    category: "Driver Qualification Files",
    type: "driver-file",
    audience: ["driver", "manager", "hr", "safety"],
    status: "available",
    description: "Completed MVR executed operational record",
  ...
  },
  {
    ...
    title: "FMCSA Executed Record — John Carter",
    cabinet: "Driver Qualification Files",
    section: "Executed Operational Records",
    category: "Driver Qualification Files",
    type: "driver-file",
    audience: ["driver", "manager", "hr", "safety"],
    status: "available",
    description: "Completed FMCSA clearinghouse executed operational record",
  ...
  },
  {
    ...
    title: "W-9 Executed Record — John Carter",
    cabinet: "Driver Qualification Files",
    section: "Executed Operational Records",
    category: "Driver Qualification Files",
    type: "driver-file",
    audience: ["driver", "manager", "finance"],
    status: "available",
    description: "Completed W-9 executed operational record",
  ...
  },
  {
    ...
    title: "Road Test Executed Record — John Carter",
    cabinet: "Driver Qualification Files",
    section: "Executed Operational Records",
    category: "Driver Qualification Files",
    type: "form",
    audience: ["driver", "manager", "hr", "safety"],
    status: "available",
    description: "Completed road test executed operational record",
  ...
  },
  {
    ...
    title: "Employment Verification Executed Record — John Carter",
    cabinet: "Driver Qualification Files",
    section: "Executed Operational Records",
    category: "Driver Qualification Files",
    type: "form",
    audience: ["driver", "manager", "hr"],
    status: "available",
    description: "Completed employment verification executed operational record",
  ...
  },
  {
    ...
    title: "Emergency Contacts Executed Record — John Carter",
    cabinet: "Driver Qualification Files",
    section: "Executed Operational Records",
    category: "Driver Qualification Files",
    type: "driver-file",
    ...
    status: "available",
    description: "Completed emergency contacts executed operational record",
  ...
  },
  {
    ...
    title: "Bank Information Executed Record — John Carter",
    cabinet: "Driver Qualification Files",
    section: "Executed Operational Records",
    category: "Driver Qualification Files",
    type: "driver-file",
    audience: ["driver", "manager", "finance"],
    status: "available",
    description: "Completed bank information executed operational record",
