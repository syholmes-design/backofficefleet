...
export function FreightCompliancePulse() {
        ...
        <div className="grid gap-8 lg:grid-cols-[0.78fr_1.22fr] lg:items-start">
          <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-xl shadow-slate-900/5 md:p-8">
            ...
            <p className="mt-5 text-base leading-8 text-slate-600">
              Live public-source updates from FMCSA, DOT, NHTSA, CSA, and federal rulemaking sources - organized by
              BOF around the workflows carriers actually manage.
            </p>
