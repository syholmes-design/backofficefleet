...
function buildCdl(driver, doc, data) {
  const inner = `
    ...
    <p class="sub">Credential type: CDL · Status reflects demo documents[] only</p>
    ${driverBlock(driver)}
    ...
    <dl>
      ...
      <dt>License number</dt><dd><span class="muted">Not on file</span></dd>
      <dt>Class / endorsements</dt><dd><span class="muted">Pending</span></dd>
      <dt>Issuing state</dt><dd><span class="muted">Not on file</span></dd>
    </dl>
  `;
