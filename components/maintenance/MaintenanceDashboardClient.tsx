    ...
    <>
      ...
      <BofAdvantageStrip>
        <BofAdvantageCard
          ...
          explanation="MAR spend total is BOF-backed from demo money-at-risk rows; percentage lift is an illustrative planning estimate pending contracted vendor tables."
          tone="positive"
        />
        <BofAdvantageCard
