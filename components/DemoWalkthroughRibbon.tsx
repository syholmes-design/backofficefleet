...
const DEMO_STEPS: DemoStep[] = [
  {
    ...
    nextLabel: "Open Exception Queue",
    nextHref: "/rf-actions",
  },
  {
    match: (pathname) => pathname.startsWith("/rf-actions"),
    label: "Risk triage",
    href: "/rf-actions",
  ...
  },
  {
    ...
    nextLabel: "Open Customer Portal",
    nextHref: "/portals/customer",
  },
  {
    match: (pathname) => pathname.startsWith("/shipper-portal") || pathname.startsWith("/portals/customer"),
