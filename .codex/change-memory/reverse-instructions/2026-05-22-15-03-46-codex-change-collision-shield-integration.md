...
1. Review the patch at `.codex/change-memory/patches/2026-05-22-15-03-46-codex-change-collision-shield-integration.patch`.
2. If the patch still applies cleanly, reverse it with `git apply -R .codex/change-memory/patches/2026-05-22-15-03-46-codex-change-collision-shield-integration.patch` from the project root.
