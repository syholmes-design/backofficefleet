...
1. Review the patch at `.codex/change-memory/patches/2026-05-22-13-01-26-expert-consensus-guardian-integration.patch`.
2. If the patch still applies cleanly, reverse it with `git apply -R .codex/change-memory/patches/2026-05-22-13-01-26-expert-consensus-guardian-integration.patch` from the project root.
